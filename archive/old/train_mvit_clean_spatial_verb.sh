...
# Configuration
MODEL_TYPE="${1:-mvit_spatial}"  # Default to temporal, can be overridden
...
OUTPUT_DIR="/mnt/k/checkpoints_mvit/mvit_${MODEL_TYPE}_${DATASET}_${TASK_TYPE}_clean/2309"

# Model checkpoint (optional - for fine-tuning)
PRETRAIN_MODEL=""/mnt/k/checkpoints_mvit/mvit_mvit_spatial_ek100_cls_verb_clean/2109/checkpoint_best.pt""
