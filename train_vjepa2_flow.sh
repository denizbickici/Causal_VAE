...
# Launcher for training V-JEPA2 (or MViT) backbones with optical-flow inputs.
# Usage:
#   ./train_vjepa2_flow.sh [MODEL_TYPE] [DATASET] [TASK_TYPE] [extra args...]
# Examples:
#   ./train_vjepa2_flow.sh vjepa2_large ek100_cls verb
#   ./train_vjepa2_flow.sh vjepa2_giant_384 ek100_cls action --batch-size 4
#   ./train_vjepa2_flow.sh mvit_temporal egtea action
#
# MODEL_TYPE options (from main_train_vjepa_flow.py):
...
# Output/checkpoints
OUTPUT_DIR="/mnt/k/checkpoints/flow_${MODEL_TYPE}_${DATASET}_${TASK_TYPE}"
mkdir -p "$OUTPUT_DIR"
...
CMD="python main_train_vjepa_flow.py \
    --dataset $DATASET \
    --root $ROOT_DIR \
